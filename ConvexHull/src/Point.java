...
/**
 * Objects of this class represent points in R^2. They have x- and y-coordinate.
 * A point offers methods to determine whether it is left of the vector between
 * some other point and a reference point looking from the reference point,
 * whether it is collinear to some other point (again considering vectors
 * originating in a common reference point), you can access and manipulate its
 * coordinates and print it out as a string.
 *
 * @author Anna Roes, Sebastian Bauer
 */
public class Point {
